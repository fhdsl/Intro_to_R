...
-   **Explicit subsetting**: Given a vector of people's ages, and subset to the 1st, 5th, and 9th elements.
...
-   **Implicit subsetting**: Given a vector of people's ages, and subset to elements greater than age 50.
...
breast_metadata = select(breast_metadata, ModelID, Age, Sex)
...
<https://forms.gle/4ZEpUjBAz4Yfw9og6>
