...
Some folks have started to wonder how to integrate what they are learning in class with their own work. Some helpful resources:

-   I run a weekly data science co-working session in which people drop in to connect about their data science work with peers and DaSL staff: <https://forms.gle/PYZPqJ9wFyvdY3A67>

-   DaSL offers a free short consulting service called Data House Calls that connects to data experts on our team: <https://ocdo.fredhutch.org/programs/dhc.html> 
...
<https://forms.gle/vo2Mgm54wwci6t9k6>
