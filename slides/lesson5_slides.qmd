...
Lunch together for last day of class next week: <https://forms.gle/aMAUKJBxd8bMtys89>
...
Can make a lineplot version by using `geom_line()`.
...
-   `labs(x = "xlabel", y = "ylabel", title = "my title")` gives axis and plot labels

-   `scale_x_continuous(limits = c(1, 10))` changes x-axis scaling, same idea for y-axis scaling

-   `theme_bw()` sets a [plot theme](https://ggplot2.tidyverse.org/reference/ggtheme.html).
...
## Class plotting gallery!

<https://docs.google.com/document/d/1igje3fWfyadVKRGPmH4ZhObZKCtMqyeyVdU4knSrUnk/edit?usp=sharing>
