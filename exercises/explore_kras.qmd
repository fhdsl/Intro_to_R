...
### Consider a different way to visualize this data: Create a histogram for non-KRAS mutated cell lines, and a different histogram for KRAS mutated cell lines.
