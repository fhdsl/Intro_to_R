...
-   Fundamental concepts in high-level programming languages (R, Python, Julia, etc.) that is transferable: *How do programs run, and how do we solve problems using functions and data structures?*
...
-   A function can have different kinds of inputs and outputs - it doesn't need to be numbers. In the `len()` function, the input is a String, and the output is a number. We will see increasingly complex functions with all sorts of different inputs and outputs.
