...
Once you have opened the project, open the file "KRAS_demo.qmd", and you should see something like this:
...
2.  Scroll down the Quarto Document, and when you see a chunk of R Code, click the green arrow button. It will copy the R code chunk to the R Console and run all of it.
